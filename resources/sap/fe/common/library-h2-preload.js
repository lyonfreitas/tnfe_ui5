 ...
 */
sap.ui.predefine('sap/fe/common/library',["sap/ui/core/Core","sap/ui/core/library"],function(){"use strict";sap.ui.getCore().initLibrary({name:"sap.fe.common",version:"1.97.0",dependencies:["sap.ui.core"],types:[],interfaces:[],controls:[],elements:[],noLibraryCSS:true});return sap.fe.common;});
sap.ui.require.preload({
	"sap/fe/common/manifest.json":'{"_version":"1.21.0","sap.app":{"id":"sap.fe.common","type":"library","embeds":[],"applicationVersion":{"version":"1.97.0"},"title":"UI5 library: sap.fe.common","description":"UI5 library: sap.fe.common","ach":"CA-UI5-FE","resources":"resources.json","offline":true},"sap.ui":{"technology":"UI5","supportedThemes":[]},"sap.ui5":{"dependencies":{"minUI5Version":"1.97","libs":{"sap.ui.core":{"minVersion":"1.97.0"}}},"library":{"i18n":false,"css":false,"content":{"controls":[],"elements":[],"types":[],"interfaces":[]}}}}'
